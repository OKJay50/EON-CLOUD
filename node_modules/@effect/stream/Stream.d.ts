 ...
 * @category constructors
 */
export declare const asyncScoped: <R, E, A>(register: (cb: (effect: Effect.Effect<R, Option.Option<E>, Chunk.Chunk<A>>) => void) => Effect.Effect<R | Scope.Scope, E, unknown>, outputBuffer?: number) => Stream<R, E, A>;
/**
 ...
 */
export declare const catchAll: <E, R2, E2, A2>(f: (error: E) => Stream<R2, E2, A2>) => <R, A>(self: Stream<R, E, A>) => Stream<R2 | R, E2, A2 | A>;
/**
 * Switches over to the stream produced by the provided function in case this
 ...
 * @category utils
 */
export declare const collectWhile: <A, A2>(pf: (a: A) => Option.Option<A2>) => <R, E>(self: Stream<R, E, A>) => Stream<R, E, A2>;
/**
 ...
 * @category utils
 */
export declare const collectWhileEffect: <A, R2, E2, A2>(pf: (a: A) => Option.Option<Effect.Effect<R2, E2, A2>>) => <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A2>;
/**
...
export declare const distributedWith: {
    <N extends number, A>(n: N, maximumLag: number, decide: (a: A) => Effect.Effect<never, never, Predicate<number>>): <R, E>(self: Stream<R, E, A>) => Effect.Effect<Scope.Scope | R, never, Stream.DynamicTuple<Queue.Dequeue<Exit.Exit<Option.Option<E>, A>>, N>>;
    <R, E, N extends number, A>(self: Stream<R, E, A>, n: N, maximumLag: number, decide: (a: A) => Effect.Effect<never, never, Predicate<number>>): Effect.Effect<Scope.Scope | R, never, Stream.DynamicTuple<Queue.Dequeue<Exit.Exit<Option.Option<E>, A>>, N>>;
};
/**
...
export declare const distributedWithDynamic: {
    <E, A, _>(maximumLag: number, decide: (a: A) => Effect.Effect<never, never, Predicate<number>>): <R>(self: Stream<R, E, A>) => Effect.Effect<Scope.Scope | R, never, Effect.Effect<never, never, readonly [number, Queue.Dequeue<Exit.Exit<Option.Option<E>, A>>]>>;
    <R, E, A, _>(self: Stream<R, E, A>, maximumLag: number, decide: (a: A) => Effect.Effect<never, never, Predicate<number>>): Effect.Effect<Scope.Scope | R, never, Effect.Effect<never, never, readonly [number, Queue.Dequeue<Exit.Exit<Option.Option<E>, A>>]>>;
};
/**
...
export declare const flatMapPar: {
    <A, R2, E2, A2>(n: number, f: (a: A) => Stream<R2, E2, A2>): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A2>;
...
export declare const flatMapParBuffer: {
    <A, R2, E2, A2>(n: number, bufferSize: number, f: (a: A) => Stream<R2, E2, A2>): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A2>;
    <R, E, A, R2, E2, A2>(self: Stream<R, E, A>, n: number, bufferSize: number, f: (a: A) => Stream<R2, E2, A2>): Stream<R | R2, E | E2, A2>;
};
/**
 * Maps each element of this stream to another stream and returns the
 * non-deterministic merge of those streams, executing up to `n` inner streams
 ...
 * @category sequencing
 */
export declare const flattenEffect: <R, E, R2, E2, A>(self: Stream<R, E, Effect.Effect<R2, E2, A>>) => Stream<R | R2, E | E2, A>;
/**
 * Flattens `Effect` values into the stream's structure, preserving all
 * information about the effect.
 *
 ...
 * @category sequencing
 */
export declare const flattenParUnbounded: <R, E, R2, E2, A>(self: Stream<R, E, Stream<R2, E2, A>>) => Stream<R | R2, E | E2, A>;
/**
 ...
 * @category constructors
 */
export declare const fromChunkHubScoped: <A>(hub: Hub.Hub<Chunk.Chunk<A>>) => Effect.Effect<Scope.Scope, never, Stream<never, never, A>>;
/**
 * Creates a stream from a subscription to a `Hub`.
 *
 ...
 * @category constructors
 */
export declare const fromChunkHubScopedWithShutdown: <A>(hub: Hub.Hub<Chunk.Chunk<A>>) => Effect.Effect<Scope.Scope, never, Stream<never, never, A>>;
/**
 ...
 * @category constructors
 */
export declare const fromHubScoped: <A>(hub: Hub.Hub<A>, maxChunkSize?: number) => Effect.Effect<Scope.Scope, never, Stream<never, never, A>>;
/**
 * Creates a stream from a subscription to a `Hub`.
 *
 * The hub will be shut down once the stream is closed.
 ...
 * @category constructors
 */
export declare const fromHubScopedWithShutdown: <A>(hub: Hub.Hub<A>, maxChunkSize?: number) => Effect.Effect<Scope.Scope, never, Stream<never, never, A>>;
/**
 ...
 * @category constructors
 */
export declare const fromPull: <R, R2, E, A>(effect: Effect.Effect<Scope.Scope | R, never, Effect.Effect<R2, Option.Option<E>, Chunk.Chunk<A>>>) => Stream<R | R2, E, A>;
/**
 * Creates a stream from a queue of values
 *
 ...
 * @category constructors
 */
export declare const fromQueueWithShutdown: <A>(queue: Queue.Dequeue<A>, maxChunkSize?: number) => Stream<never, never, A>;
/**
...
export declare const groupBy: {
    <A, R2, E2, K, V>(f: (a: A) => Effect.Effect<R2, E2, readonly [K, V]>): <R, E>(self: Stream<R, E, A>) => GroupBy.GroupBy<R2 | R, E2 | E, K, V>;
    <R, E, A, R2, E2, K, V>(self: Stream<R, E, A>, f: (a: A) => Effect.Effect<R2, E2, readonly [K, V]>): GroupBy.GroupBy<R | R2, E | E2, K, V>;
};
/**
...
export declare const groupByBuffer: {
    <A, R2, E2, K, V>(f: (a: A) => Effect.Effect<R2, E2, readonly [K, V]>, bufferSize: number): <R, E>(self: Stream<R, E, A>) => GroupBy.GroupBy<R2 | R, E2 | E, K, V>;
    <R, E, A, R2, E2, K, V>(self: Stream<R, E, A>, f: (a: A) => Effect.Effect<R2, E2, readonly [K, V]>, bufferSize: number): GroupBy.GroupBy<R | R2, E | E2, K, V>;
};
/**
...
export declare const mapEffectPar: {
    <A, R2, E2, A2>(n: number, f: (a: A) => Effect.Effect<R2, E2, A2>): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A2>;
    <R, E, A, R2, E2, A2>(self: Stream<R, E, A>, n: number, f: (a: A) => Effect.Effect<R2, E2, A2>): Stream<R | R2, E | E2, A2>;
};
/**
 * Maps over elements of the stream with the specified effectful function,
...
export declare const mapEffectParByKey: {
    <R2, E2, A2, A, K>(keyBy: (a: A) => K, f: (a: A) => Effect.Effect<R2, E2, A2>): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A2>;
    <R, E, R2, E2, A2, A, K>(self: Stream<R, E, A>, keyBy: (a: A) => K, f: (a: A) => Effect.Effect<R2, E2, A2>): Stream<R | R2, E | E2, A2>;
};
/**
...
export declare const mapEffectParByKeyBuffer: {
    <R2, E2, A2, A, K>(keyBy: (a: A) => K, bufferSize: number, f: (a: A) => Effect.Effect<R2, E2, A2>): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A2>;
    <R, E, R2, E2, A2, A, K>(self: Stream<R, E, A>, keyBy: (a: A) => K, bufferSize: number, f: (a: A) => Effect.Effect<R2, E2, A2>): Stream<R | R2, E | E2, A2>;
};
/**
 * Maps over elements of the stream with the specified effectful function,
...
export declare const mergeHaltStrategy: {
    <R2, E2, A2>(that: Stream<R2, E2, A2>, strategy: HaltStrategy.HaltStrategy): <R, E, A>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A2 | A>;
    <R, E, A, R2, E2, A2>(self: Stream<R, E, A>, that: Stream<R2, E2, A2>, strategy: HaltStrategy.HaltStrategy): Stream<R | R2, E | E2, A | A2>;
};
/**
 ...
 * @category utils
 */
export declare const mergeAll: (n: number, bufferSize?: number) => <R, E, A>(...streams: Array<Stream<R, E, A>>) => Stream<R, E, A>;
/**
 ...
 * @category utils
 */
export declare const mergeAllUnbounded: (bufferSize?: number) => <R, E, A>(...streams: Array<Stream<R, E, A>>) => Stream<R, E, A>;
/**
...
export declare const mergeWith: {
    <R2, E2, A2, A, A3, A4>(that: Stream<R2, E2, A2>, left: (a: A) => A3, right: (a2: A2) => A4): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A3 | A4>;
    <R, E, R2, E2, A2, A, A3, A4>(self: Stream<R, E, A>, that: Stream<R2, E2, A2>, left: (a: A) => A3, right: (a2: A2) => A4): Stream<R | R2, E | E2, A3 | A4>;
};
/**
...
export declare const mergeWithHaltStrategy: {
    <R2, E2, A2, A, A3, A4>(that: Stream<R2, E2, A2>, left: (a: A) => A3, right: (a2: A2) => A4, strategy: HaltStrategy.HaltStrategy): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A3 | A4>;
    <R, E, R2, E2, A2, A, A3, A4>(self: Stream<R, E, A>, that: Stream<R2, E2, A2>, left: (a: A) => A3, right: (a2: A2) => A4, strategy: HaltStrategy.HaltStrategy): Stream<R | R2, E | E2, A3 | A4>;
};
/**
...
export declare const orElseOptional: {
    <R2, E2, A2>(that: LazyArg<Stream<R2, Option.Option<E2>, A2>>): <R, E, A>(self: Stream<R, Option.Option<E>, A>) => Stream<R2 | R, Option.Option<E2 | E>, A2 | A>;
    <R, E, A, R2, E2, A2>(self: Stream<R, Option.Option<E>, A>, that: LazyArg<Stream<R2, Option.Option<E2>, A2>>): Stream<R | R2, Option.Option<E | E2>, A | A2>;
};
/**
...
export declare const partition: {
    <A>(predicate: Predicate<A>): <R, E>(self: Stream<R, E, A>) => Effect.Effect<Scope.Scope | R, E, readonly [Stream<never, E, A>, Stream<never, E, A>]>;
    <R, E, A>(self: Stream<R, E, A>, predicate: Predicate<A>): Effect.Effect<Scope.Scope | R, E, readonly [Stream<never, E, A>, Stream<never, E, A>]>;
};
/**
...
export declare const partitionBuffer: {
    <A>(predicate: Predicate<A>, bufferSize: number): <R, E>(self: Stream<R, E, A>) => Effect.Effect<R | Scope.Scope, E, readonly [Stream<never, E, A>, Stream<never, E, A>]>;
    <R, E, A>(self: Stream<R, E, A>, predicate: Predicate<A>, bufferSize: number): Effect.Effect<Scope.Scope | R, E, readonly [Stream<never, E, A>, Stream<never, E, A>]>;
};
/**
...
export declare const partitionEither: {
    <A, R2, E2, A2, A3>(predicate: (a: A) => Effect.Effect<R2, E2, Either.Either<A2, A3>>): <R, E>(self: Stream<R, E, A>) => Effect.Effect<Scope.Scope | R2 | R, E2 | E, readonly [Stream<never, E2 | E, A2>, Stream<never, E2 | E, A3>]>;
    <R, E, A, R2, E2, A2, A3>(self: Stream<R, E, A>, predicate: (a: A) => Effect.Effect<R2, E2, Either.Either<A2, A3>>): Effect.Effect<Scope.Scope | R | R2, E | E2, readonly [Stream<never, E | E2, A2>, Stream<never, E | E2, A3>]>;
};
/**
...
export declare const partitionEitherBuffer: {
    <A, R2, E2, A2, A3>(predicate: (a: A) => Effect.Effect<R2, E2, Either.Either<A2, A3>>, bufferSize: number): <R, E>(self: Stream<R, E, A>) => Effect.Effect<Scope.Scope | R2 | R, E2 | E, readonly [Stream<never, E2 | E, A2>, Stream<never, E2 | E, A3>]>;
    <R, E, A, R2, E2, A2, A3>(self: Stream<R, E, A>, predicate: (a: A) => Effect.Effect<R2, E2, Either.Either<A2, A3>>, bufferSize: number): Effect.Effect<Scope.Scope | R | R2, E | E2, readonly [Stream<never, E | E2, A2>, Stream<never, E | E2, A3>]>;
};
/**
...
export declare const provideService: {
    <T extends Context.Tag<any, any>>(tag: T, resource: Context.Tag.Service<T>): <R, E, A>(self: Stream<R, E, A>) => Stream<Exclude<R, Context.Tag.Service<T>>, E, A>;
    <R, E, A, T extends Context.Tag<any, any>>(self: Stream<R, E, A>, tag: T, resource: Context.Tag.Service<T>): Stream<Exclude<R, Context.Tag.Service<T>>, E, A>;
};
/**
 * Provides the stream with the single service it requires. If the stream
 * requires more than one service use `Stream.provideContext` instead.
...
export declare const provideServiceEffect: {
    <T extends Context.Tag<any, any>, R2, E2>(tag: T, effect: Effect.Effect<R2, E2, Context.Tag.Service<T>>): <R, E, A>(self: Stream<R, E, A>) => Stream<R2 | Exclude<R, Context.Tag.Service<T>>, E2 | E, A>;
    <R, E, A, T extends Context.Tag<any, any>, R2, E2>(self: Stream<R, E, A>, tag: T, effect: Effect.Effect<R2, E2, Context.Tag.Service<T>>): Stream<R2 | Exclude<R, Context.Tag.Service<T>>, E | E2, A>;
};
/**
 * Provides the stream with the single service it requires. If the stream
 * requires more than one service use `Stream.provideContext` instead.
...
export declare const provideServiceStream: {
    <T extends Context.Tag<any, any>, R2, E2>(tag: T, stream: Stream<R2, E2, Context.Tag.Service<T>>): <R, E, A>(self: Stream<R, E, A>) => Stream<R2 | Exclude<R, Context.Tag.Service<T>>, E2 | E, A>;
    <R, E, A, T extends Context.Tag<any, any>, R2, E2>(self: Stream<R, E, A>, tag: T, stream: Stream<R2, E2, Context.Tag.Service<T>>): Stream<R2 | Exclude<R, Context.Tag.Service<T>>, E | E2, A>;
};
/**
 ...
 * @category constructors
 */
export declare const repeatEffectWithSchedule: <R, E, A, R2, _>(effect: Effect.Effect<R, E, A>, schedule: Schedule.Schedule<R2, A, _>) => Stream<R | R2, E, A>;
/**
 * Repeats the entire stream using the specified schedule. The stream will
 * execute normally, and then repeat again according to the provided schedule.
...
export declare const repeatElementsWith: {
    <R2, B, A, C>(schedule: Schedule.Schedule<R2, unknown, B>, f: (a: A) => C, g: (b: B) => C): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E, C>;
    <R, E, R2, B, A, C>(self: Stream<R, E, A>, schedule: Schedule.Schedule<R2, unknown, B>, f: (a: A) => C, g: (b: B) => C): Stream<R | R2, E, C>;
};
/**
...
export declare const scheduleEither: {
    <R2, A, B>(schedule: Schedule.Schedule<R2, A, B>): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E, Either.Either<B, A>>;
...
export declare const scheduleWith: {
    <R2, A, B, C>(schedule: Schedule.Schedule<R2, A, B>, f: (a: A) => C, g: (b: B) => C): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E, C>;
    <R, E, R2, A, B, C>(self: Stream<R, E, A>, schedule: Schedule.Schedule<R2, A, B>, f: (a: A) => C, g: (b: B) => C): Stream<R | R2, E, C>;
};
/**
 ...
 * @category constructors
 */
export declare const scoped: <R, E, A>(effect: Effect.Effect<Scope.Scope | R, E, A>) => Stream<Exclude<R, Scope.Scope>, E, A>;
/**
...
export declare const tapErrorCause: {
    <E, R2, E2, _>(f: (cause: Cause.Cause<E>) => Effect.Effect<R2, E2, _>): <R, A>(self: Stream<R, E, A>) => Stream<R2 | R, E | E2, A>;
...
export declare const throttleEnforce: {
    <A>(costFn: (chunk: Chunk.Chunk<A>) => number, units: number, duration: Duration.Duration): <R, E>(self: Stream<R, E, A>) => Stream<R, E, A>;
    <R, E, A>(self: Stream<R, E, A>, costFn: (chunk: Chunk.Chunk<A>) => number, units: number, duration: Duration.Duration): Stream<R, E, A>;
};
/**
...
export declare const throttleEnforceBurst: {
    <A>(costFn: (chunk: Chunk.Chunk<A>) => number, units: number, duration: Duration.Duration, burst: number): <R, E>(self: Stream<R, E, A>) => Stream<R, E, A>;
    <R, E, A>(self: Stream<R, E, A>, costFn: (chunk: Chunk.Chunk<A>) => number, units: number, duration: Duration.Duration, burst: number): Stream<R, E, A>;
};
/**
 * Throttles the chunks of this stream according to the given bandwidth
 * parameters using the token bucket algorithm. Allows for burst in the
...
export declare const throttleEnforceEffect: {
    <A, R2, E2>(costFn: (chunk: Chunk.Chunk<A>) => Effect.Effect<R2, E2, number>, units: number, duration: Duration.Duration): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A>;
    <R, E, A, R2, E2>(self: Stream<R, E, A>, costFn: (chunk: Chunk.Chunk<A>) => Effect.Effect<R2, E2, number>, units: number, duration: Duration.Duration): Stream<R | R2, E | E2, A>;
};
/**
...
export declare const throttleEnforceEffectBurst: {
    <A, R2, E2>(costFn: (chunk: Chunk.Chunk<A>) => Effect.Effect<R2, E2, number>, units: number, duration: Duration.Duration, burst: number): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A>;
    <R, E, A, R2, E2>(self: Stream<R, E, A>, costFn: (chunk: Chunk.Chunk<A>) => Effect.Effect<R2, E2, number>, units: number, duration: Duration.Duration, burst: number): Stream<R | R2, E | E2, A>;
};
/**
...
export declare const timeoutFailCause: {
    <E2>(cause: LazyArg<Cause.Cause<E2>>, duration: Duration.Duration): <R, E, A>(self: Stream<R, E, A>) => Stream<R, E2 | E, A>;
    <R, E, A, E2>(self: Stream<R, E, A>, cause: LazyArg<Cause.Cause<E2>>, duration: Duration.Duration): Stream<R, E | E2, A>;
};
/**
...
export declare const timeoutTo: {
    <R2, E2, A2>(duration: Duration.Duration, that: Stream<R2, E2, A2>): <R, E, A>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A2 | A>;
    <R, E, A, R2, E2, A2>(self: Stream<R, E, A>, duration: Duration.Duration, that: Stream<R2, E2, A2>): Stream<R | R2, E | E2, A | A2>;
};
/**
 ...
 * @category destructors
 */
export declare const toQueue: <R, E, A>(self: Stream<R, E, A>) => Effect.Effect<Scope.Scope | R, never, Queue.Dequeue<Take.Take<E, A>>>;
/**
...
export declare const toQueueCapacity: {
    (capacity: number): <R, E, A>(self: Stream<R, E, A>) => Effect.Effect<Scope.Scope | R, never, Queue.Dequeue<Take.Take<E, A>>>;
    <R, E, A>(self: Stream<R, E, A>, capacity: number): Effect.Effect<Scope.Scope | R, never, Queue.Dequeue<Take.Take<E, A>>>;
};
/**
 ...
 * @category destructors
 */
export declare const toQueueDropping: <R, E, A>(self: Stream<R, E, A>) => Effect.Effect<Scope.Scope | R, never, Queue.Dequeue<Take.Take<E, A>>>;
/**
 ...
 * @category destructors
 */
export declare const toQueueOfElements: <R, E, A>(self: Stream<R, E, A>) => Effect.Effect<Scope.Scope | R, never, Queue.Dequeue<Exit.Exit<Option.Option<E>, A>>>;
/**
...
export declare const toQueueOfElementsCapacity: {
    (capacity: number): <R, E, A>(self: Stream<R, E, A>) => Effect.Effect<Scope.Scope | R, never, Queue.Dequeue<Exit.Exit<Option.Option<E>, A>>>;
    <R, E, A>(self: Stream<R, E, A>, capacity: number): Effect.Effect<Scope.Scope | R, never, Queue.Dequeue<Exit.Exit<Option.Option<E>, A>>>;
};
/**
 ...
 * @category destructors
 */
export declare const toQueueSliding: <R, E, A>(self: Stream<R, E, A>) => Effect.Effect<Scope.Scope | R, never, Queue.Dequeue<Take.Take<E, A>>>;
/**
 ...
 * @category destructors
 */
export declare const toQueueUnbounded: <R, E, A>(self: Stream<R, E, A>) => Effect.Effect<Scope.Scope | R, never, Queue.Dequeue<Take.Take<E, A>>>;
/**
 ...
 * @category constructors
 */
export declare const unwrapScoped: <R, E, R2, E2, A>(effect: Effect.Effect<Scope.Scope | R, E, Stream<R2, E2, A>>) => Stream<Exclude<R | Scope.Scope, Scope.Scope> | R2, E | E2, A>;
/**
...
export declare const zipAll: {
    <R2, E2, A2, A>(that: Stream<R2, E2, A2>, defaultLeft: A, defaultRight: A2): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, readonly [A, A2]>;
    <R, E, R2, E2, A2, A>(self: Stream<R, E, A>, that: Stream<R2, E2, A2>, defaultLeft: A, defaultRight: A2): Stream<R | R2, E | E2, readonly [A, A2]>;
};
/**
...
export declare const zipAllSortedByKey: {
    <R2, E2, A2, A, K>(that: Stream<R2, E2, readonly [K, A2]>, defaultLeft: A, defaultRight: A2, order: Order.Order<K>): <R, E>(self: Stream<R, E, readonly [K, A]>) => Stream<R2 | R, E2 | E, readonly [K, readonly [A, A2]]>;
    <R, E, R2, E2, A2, A, K>(self: Stream<R, E, readonly [K, A]>, that: Stream<R2, E2, readonly [K, A2]>, defaultLeft: A, defaultRight: A2, order: Order.Order<K>): Stream<R | R2, E | E2, readonly [K, readonly [A, A2]]>;
};
/**
 * Zips this stream that is sorted by distinct keys and the specified stream
 * that is sorted by distinct keys to produce a new stream that is sorted by
...
export declare const zipAllSortedByKeyLeft: {
    <R2, E2, A2, A, K>(that: Stream<R2, E2, readonly [K, A2]>, defaultLeft: A, order: Order.Order<K>): <R, E>(self: Stream<R, E, readonly [K, A]>) => Stream<R2 | R, E2 | E, readonly [K, A]>;
    <R, E, R2, E2, A2, A, K>(self: Stream<R, E, readonly [K, A]>, that: Stream<R2, E2, readonly [K, A2]>, defaultLeft: A, order: Order.Order<K>): Stream<R | R2, E | E2, readonly [K, A]>;
};
/**
 * Zips this stream that is sorted by distinct keys and the specified stream
 * that is sorted by distinct keys to produce a new stream that is sorted by
...
export declare const zipAllSortedByKeyRight: {
    <R2, E2, A2, K>(that: Stream<R2, E2, readonly [K, A2]>, defaultRight: A2, order: Order.Order<K>): <R, E, A>(self: Stream<R, E, readonly [K, A]>) => Stream<R2 | R, E2 | E, readonly [K, A2]>;
    <R, E, A, R2, E2, A2, K>(self: Stream<R, E, readonly [K, A]>, that: Stream<R2, E2, readonly [K, A2]>, defaultRight: A2, order: Order.Order<K>): Stream<R | R2, E | E2, readonly [K, A2]>;
};
/**
 * Zips this stream that is sorted by distinct keys and the specified stream
 * that is sorted by distinct keys to produce a new stream that is sorted by
...
export declare const zipAllSortedByKeyWith: {
    <R2, E2, A, A3, A2, K>(that: Stream<R2, E2, readonly [K, A2]>, left: (a: A) => A3, right: (a2: A2) => A3, both: (a: A, a2: A2) => A3, order: Order.Order<K>): <R, E>(self: Stream<R, E, readonly [K, A]>) => Stream<R2 | R, E2 | E, readonly [K, A3]>;
    <R, E, R2, E2, A, A3, A2, K>(self: Stream<R, E, readonly [K, A]>, that: Stream<R2, E2, readonly [K, A2]>, left: (a: A) => A3, right: (a2: A2) => A3, both: (a: A, a2: A2) => A3, order: Order.Order<K>): Stream<R | R2, E | E2, readonly [K, A3]>;
};
/**
...
export declare const zipAllWith: {
    <R2, E2, A2, A, A3>(that: Stream<R2, E2, A2>, left: (a: A) => A3, right: (a2: A2) => A3, both: (a: A, a2: A2) => A3): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E2 | E, A3>;
    <R, E, R2, E2, A2, A, A3>(self: Stream<R, E, A>, that: Stream<R2, E2, A2>, left: (a: A) => A3, right: (a2: A2) => A3, both: (a: A, a2: A2) => A3): Stream<R | R2, E | E2, A3>;
};
/**
...
export declare const bind: {
    <N extends string, A extends object, O2, E2, B>(name: Exclude<N, keyof A>, f: (a: A) => Stream<O2, E2, B>): <O1, E1>(self: Stream<O1, E1, A>) => Stream<O2 | O1, E2 | E1, {
        [K in N | keyof A]: K extends keyof A ? A[K] : B;
    }>;
    <O1_1, E1_1, A_1 extends object, N_1 extends string, O2_1, E2_1, B_1>(self: Stream<O1_1, E1_1, A_1>, name: Exclude<N_1, keyof A_1>, f: (a: A_1) => Stream<O2_1, E2_1, B_1>): Stream<O1_1 | O2_1, E1_1 | E2_1, {
...
export declare const bindDiscard: {
    <N extends string, A extends object, O2, E2, B>(name: Exclude<N, keyof A>, f: Stream<O2, E2, B>): <O1, E1>(self: Stream<O1, E1, A>) => Stream<O2 | O1, E2 | E1, {
        [K in N | keyof A]: K extends keyof A ? A[K] : B;
    }>;
    <O1_1, E1_1, A_1 extends object, N_1 extends string, O2_1, E2_1, B_1>(self: Stream<O1_1, E1_1, A_1>, name: Exclude<N_1, keyof A_1>, f: Stream<O2_1, E2_1, B_1>): Stream<O1_1 | O2_1, E1_1 | E2_1, {
        [K_1 in N_1 | keyof A_1]: K_1 extends keyof A_1 ? A_1[K_1] : B_1;
    }>;
};
declare const let_: {
    <N extends string, A extends object, B>(name: Exclude<N, keyof A>, f: (a: A) => B): <O, E>(self: Stream<O, E, A>) => Stream<O, E, {
        [K in N | keyof A]: K extends keyof A ? A[K] : B;
    }>;
    <O_1, E_1, A_1 extends object, N_1 extends string, B_1>(self: Stream<O_1, E_1, A_1>, name: Exclude<N_1, keyof A_1>, f: (a: A_1) => B_1): Stream<O_1, E_1, {
        [K_1 in N_1 | keyof A_1]: K_1 extends keyof A_1 ? A_1[K_1] : B_1;
    }>;
};
export { 
...
export declare const letDiscard: {
    <N extends string, A extends object, B>(name: Exclude<N, keyof A>, b: B): <O, E>(self: Stream<O, E, A>) => Stream<O, E, {
        [K in N | keyof A]: K extends keyof A ? A[K] : B;
    }>;
    <O_1, E_1, A_1 extends object, N_1 extends string, B_1>(self: Stream<O_1, E_1, A_1>, name: Exclude<N_1, keyof A_1>, b: B_1): Stream<O_1, E_1, {
        [K_1 in N_1 | keyof A_1]: K_1 extends keyof A_1 ? A_1[K_1] : B_1;
    }>;
};
