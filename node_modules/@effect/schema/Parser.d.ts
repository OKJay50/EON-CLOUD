 ...
 * @since 1.0.0
 */
export declare const parseEffect: <_, A>(schema: Schema<_, A>) => (i: unknown, options?: ParseOptions) => Effect.Effect<never, PR.ParseError, A>;
/**
 * @category decoding
 * @since 1.0.0
 */
 ...
 * @since 1.0.0
 */
export declare const validateResult: <_, A>(schema: Schema<_, A>) => (a: unknown, options?: ParseOptions) => ParseResult<A>;
/**
 * @category validation
 * @since 1.0.0
 */
 ...
 * @since 1.0.0
 */
export declare const validateEffect: <_, A>(schema: Schema<_, A>) => (a: unknown, options?: ParseOptions) => Effect.Effect<never, PR.ParseError, A>;
/**
 * @category validation
 * @since 1.0.0
 */
 ...
 * @since 1.0.0
 */
export declare const encodeEffect: <I, A>(schema: Schema<I, A>) => (a: A, options?: ParseOptions) => Effect.Effect<never, PR.ParseError, I>;
