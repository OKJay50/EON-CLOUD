...
const formatExpected = ast => {
  switch (ast._tag) {
    ...
    case "Tuple":
      return (0, _Function.pipe)(getExpected(ast), O.getOrElse(() => "<anonymous tuple or array schema>"));
    case "TypeLiteral":
      return (0, _Function.pipe)(getExpected(ast), O.getOrElse(() => "<anonymous type literal schema>"));
    case "Enums":
