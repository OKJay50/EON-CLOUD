...
export interface ConfigErrorReducer<C, Z> {
    ...
    readonly sourceUnavailableCase: (context: C, path: Chunk.Chunk<string>, message: string, cause: Cause.Cause<unknown>) => Z;
 ...
 * @category constructors
 */
export declare const SourceUnavailable: (path: Chunk.Chunk<string>, message: string, cause: Cause.Cause<unknown>) => ConfigError;
/**
 * @since 1.0.0
 * @category constructors
 */
