...
/** @internal */
export const make = /*#__PURE__*/Debug.methodWithTrace(trace => (get, size) => makeWith(get, size, size, new NoneStrategy()).traced(trace));
/** @internal */
export const makeWithTTL = /*#__PURE__*/Debug.methodWithTrace(trace => (get, min, max, timeToLive) => makeWith(get, min, max, new TimeToLiveStrategy(timeToLive)).traced(trace));
/** @internal */
export const get = /*#__PURE__*/Debug.methodWithTrace(trace => self => self.get().traced(trace));
/** @internal */
export const invalidate = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, value) => self.invalidate(value).traced(trace));
