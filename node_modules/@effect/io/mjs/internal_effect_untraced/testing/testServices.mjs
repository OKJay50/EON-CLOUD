 ...
 * @internal
 */
export const annotationsWith = /*#__PURE__*/Debug.methodWithTrace(trace => f => core.fiberRefGetWith(currentServices, services => f(Context.get(Annotations.Annotations)(services))).traced(trace));
/**
 ...
 * @internal
 */
export const withAnnotations = /*#__PURE__*/Debug.dualWithTrace(2, trace => (effect, annotations) => core.fiberRefLocallyWith(currentServices, Context.add(Annotations.Annotations, annotations))(effect).traced(trace));
/**
 ...
 * @internal
 */
export const withAnnotationsScoped = /*#__PURE__*/Debug.methodWithTrace(trace => annotations => fiberRuntime.fiberRefLocallyScopedWith(currentServices, Context.add(Annotations.Annotations, annotations)).traced(trace));
/**
 * Constructs a new `Annotations` service wrapped in a layer.
 *
 * @internal
 */
export const annotationsLayer = /*#__PURE__*/Debug.untracedMethod(() => () => layer.scoped(Annotations.Annotations, core.tap(withAnnotationsScoped)(core.map(Annotations.make)(core.sync(() => ref.unsafeMake(TestAnnotationMap.empty()))))));
/**
 ...
 * @internal
 */
export const liveWith = /*#__PURE__*/Debug.methodWithTrace((trace, restore) => f => core.fiberRefGetWith(currentServices, services => restore(f)(Context.get(Live.Live)(services))).traced(trace));
/**
 * Executes the specified workflow with the specified implementation of the
 * live service.
 *
 * @internal
 */
export const withLive = /*#__PURE__*/Debug.dualWithTrace(2, trace => (effect, live) => core.fiberRefLocallyWith(currentServices, Context.add(Live.Live, live))(effect).traced(trace));
/**
 ...
 * @internal
 */
export const withLiveScoped = /*#__PURE__*/Debug.methodWithTrace(trace => live => fiberRuntime.fiberRefLocallyScopedWith(currentServices, Context.add(Live.Live, live)).traced(trace));
/**
 * Constructs a new `Live` service wrapped in a layer.
 *
 * @internal
 */
export const liveLayer = /*#__PURE__*/Debug.untracedMethod(() => () => layer.scoped(Live.Live, core.tap(withLiveScoped)(core.map(Live.make)(core.context()))));
/**
 ...
 * @internal
 */
export const sizedWith = /*#__PURE__*/Debug.methodWithTrace((trace, restore) => f => core.fiberRefGetWith(currentServices, services => restore(f)(Context.get(Sized.Sized)(services))).traced(trace));
/**
 * Executes the specified workflow with the specified implementation of the
 * sized service.
 *
 * @internal
 */
export const withSized = /*#__PURE__*/Debug.dualWithTrace(2, trace => (effect, sized) => core.fiberRefLocallyWith(currentServices, Context.add(Sized.Sized, sized))(effect).traced(trace));
/**
 ...
 * @internal
 */
export const withSizedScoped = /*#__PURE__*/Debug.methodWithTrace(trace => sized => fiberRuntime.fiberRefLocallyScopedWith(currentServices, Context.add(Sized.Sized, sized)).traced(trace));
/** @internal */
export const sizedLayer = /*#__PURE__*/Debug.untracedMethod(() => size => layer.scoped(Sized.Sized, core.tap(withSizedScoped)(core.map(Sized.fromFiberRef)(fiberRuntime.fiberRefMake(size)))));
/** @internal */
 ...
 * @internal
 */
export const testConfigWith = /*#__PURE__*/Debug.methodWithTrace((trace, restore) => f => core.fiberRefGetWith(currentServices, services => restore(f)(Context.get(TestConfig.TestConfig)(services))).traced(trace));
/**
 * Executes the specified workflow with the specified implementation of the
 * config service.
 *
 * @internal
 */
export const withTestConfig = /*#__PURE__*/Debug.dualWithTrace(2, trace => (effect, config) => core.fiberRefLocallyWith(currentServices, Context.add(TestConfig.TestConfig, config))(effect).traced(trace));
/**
 ...
 * @internal
 */
export const withTestConfigScoped = /*#__PURE__*/Debug.methodWithTrace(trace => config => fiberRuntime.fiberRefLocallyScopedWith(currentServices, Context.add(TestConfig.TestConfig, config)).traced(trace));
/**
 * Constructs a new `TestConfig` service with the specified settings.
 *
 * @internal
 */
export const testConfigLayer = /*#__PURE__*/Debug.untracedMethod(() => params => layer.scoped(TestConfig.TestConfig, Effect.suspend(() => {
