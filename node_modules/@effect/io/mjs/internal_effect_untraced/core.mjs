...
/** @internal */
export const unhandledErrorLogLevel = /*#__PURE__*/fiberRefUnsafeMake( /*#__PURE__*/Option.some(logLevelDebug), _ => _, (_, x) => x);
/** @internal */
export const withUnhandledErrorLogLevel = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, level) => fiberRefLocally(self, unhandledErrorLogLevel, level).traced(trace));
/** @internal */
