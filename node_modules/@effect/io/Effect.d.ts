...
export declare const mapAccum: {
    <A, B, R, E, Z>(zero: Z, f: (z: Z, a: A) => Effect<R, E, readonly [Z, B]>): (elements: Iterable<A>) => Effect<R, E, [Z, Chunk.Chunk<B>]>;
    <A, B, R, E, Z>(elements: Iterable<A>, zero: Z, f: (z: Z, a: A) => Effect<R, E, readonly [Z, B]>): Effect<R, E, [Z, Chunk.Chunk<B>]>;
};
/**
...
export declare const partition: {
    <R, E, A, B>(f: (a: A) => Effect<R, E, B>): (elements: Iterable<A>) => Effect<R, never, [Chunk.Chunk<E>, Chunk.Chunk<B>]>;
