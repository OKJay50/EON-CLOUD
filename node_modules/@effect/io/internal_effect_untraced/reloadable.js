...
const get = /*#__PURE__*/Debug.methodWithTrace(trace => tag => core.flatMap(reloadableTag(tag), reloadable => scopedRef.get(reloadable.scopedRef)).traced(trace));
/** @internal */
exports.get = get;
const manual = (tag, layer) => {
...
const reload = /*#__PURE__*/Debug.methodWithTrace(trace => tag => core.flatMap(reloadableTag(tag), reloadable => reloadable.reload()).traced(trace));
/** @internal */
exports.reload = reload;
const reloadFork = /*#__PURE__*/Debug.methodWithTrace(trace => tag => core.flatMap(reloadableTag(tag), reloadable => core.asUnit(fiberRuntime.forkDaemon(effect.ignoreLogged(reloadable.reload()))).traced(trace)));
