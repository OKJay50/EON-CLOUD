...
const mapAccum = /*#__PURE__*/Debug.dualWithTrace(3, (trace, restore) => (elements, zero, f) => core.suspend(() => {
  ...
  return core.map(result, z => (0, _ReadonlyArray.tuple)(z, Chunk.unsafeFromArray(builder)));
}).traced(trace));
/* @internal */
...
const summarized = /*#__PURE__*/Debug.dualWithTrace(3, (trace, restore) => (self, summary, f) => core.flatMap(summary, start => core.flatMap(self, value => core.map(summary, end => (0, _ReadonlyArray.tuple)(restore(f)(start, end), value)))).traced(trace));
/* @internal */
...
const attemptCatchPromiseInterrupt = /*#__PURE__*/Debug.methodWithTrace((trace, restore) => (evaluate, onReject) => core.suspend(() => {
  const controller = new AbortController();
...
const validate = /*#__PURE__*/Debug.dualWithTrace(2, trace => (self, that) => validateWith(self, that, (a, b) => (0, _ReadonlyArray.tuple)(a, b)).traced(trace));
/* @internal */
...
const whenFiberRef = /*#__PURE__*/Debug.dualWithTrace(3, (trace, restore) => (self, fiberRef, predicate) => core.flatMap(core.fiberRefGet(fiberRef), s => restore(predicate)(s) ? core.map(self, a => (0, _ReadonlyArray.tuple)(s, Option.some(a))) : core.succeed([s, Option.none()])).traced(trace));
/* @internal */
exports.whenFiberRef = whenFiberRef;
const whenRef = /*#__PURE__*/Debug.dualWithTrace(3, (trace, restore) => (self, ref, predicate) => core.flatMap(Ref.get(ref), s => restore(predicate)(s) ? core.map(self, a => (0, _ReadonlyArray.tuple)(s, Option.some(a))) : core.succeed([s, Option.none()])).traced(trace));
/* @internal */
