...
function applyPath(valueProducers, shrink, nonEmptyPath) {
    ...
    return (0, PathWalker_1.pathWalk)(adaptedPath, pathStream, shrink);
}
function check(rawProperty, params) {
    ...
    const initialValues = qParams.path.length === 0
        ...
        : applyPath((0, Tosser_1.lazyToss)(property, qParams.seed, qParams.randomType, qParams.examples), shrink, qParams.path);
